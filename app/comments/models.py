...
class Comment(RevisionMixin, PreviewableMixin, TranslatableMixin, models.Model):
    ...
    content = models.TextField(max_length=150, null=False, verbose_name="Contenido")
